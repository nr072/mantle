...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    // 'hh:mm' part is kept.
    dividedDueTime: function dividedDueTime() {
      if (!this.task.dueTime) {
        return;
      }

      var parts = new Date(this.task.dueTime).toISOString().split('T');
      return {
        date: parts[0],
  ...
  methods: {
    ...
    showEditSection: function showEditSection() {
      ...
      this.isEditing = true; // The task name input field is pre-filled with the current
      // name.

      this.newName = this.task.name; // If a task has a due time, the date and the time inputs
      // are pre-filled.
    ...
    updateTask: function updateTask() {
      var data = {}; // Only new values are sent to the back-end for update.

      if (this.task.name.trim() !== this.newName) {
        data.name = this.newName;
      }

      var newDueTime = new Date(this.newDate + ' ' + this.newTime);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.new-time-input[data-v-e9a53c20] {\n    width: 50px;\n}\n\n", ""]);
// Exports
  ...
  return _c("li", [
      ...
      [
        _vm._v(
          "\n\n        " +
            ...
            "\n        " +
            _vm._s(_vm.task.dueTime && _vm.leftTime) +
            "\n\n        "
        ),
        _c(
          "button",
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("button", { on: { click: _vm.removeDueTime } }, [
          _vm._v("Remove time")
        ]),
        _vm._v(" "),
        _c("div", [
